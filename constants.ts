...
export const ALL_ENEMIES: Record<string, Enemy> = {
  ...
  e_king_metal_mitchy: { // New Rare Enemy
    id: "e_king_metal_mitchy", 
    name: "キングメタルミッチー", 
    spriteUrl: "https://imgur.com/X7S9sWv.gif", // Ensure .gif if it's animated
    stats: { 
        maxHp: 35, currentHp: 35, maxMp: 50, currentMp: 50, // Gave it some MP for a rare spell
        attack: 10, defense: 999, speed: 200, 
        goldYield: 1050, expYield: 10050 
    },
    skills: [ALL_SKILLS.s_escape, ALL_SKILLS.s_blizzard], // Primarily escapes, rarely casts a spell
    aiBehavior: "ぼうぎょてき", // To prioritize escape
...
export const REGIONS: Record<string, Region> = {
  ...
  r_micchy_castle: {
    ...
    encounters: [/* No regular encounters, or add very tough ones */], 
